...
const GridItem: FC<GridItemProps> = ({ icon, heading, title }) => {
  return (
    <div className="flex flex-col rounded-lg bg-gray-800 p-3 shadow-md">
      ...
      <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
        ...
        <GridItem
          icon={
            <svg
              ...
              height="24"
              viewBox="0 0 24 24"
              className="fill: rgba(248, 248, 72, 1)"
            >
        ...
        <GridItem
          icon={
            ...
            >
              <path
                d="M16 0l5.196 7.552L16 15.104 10.804 7.552z"
                fill="#2a3a5b"
              />
              <path d="M0 16l5.196-7.552L0 0l5.196 7.552z" fill="#2a3a5b" />
              <path
                d="M31.916 16L26.72 23.448 31.916 31L26.72 23.448z"
                fill="#1a2a3d"
              />
            </svg>
          }
        ...
        <GridItem
          icon={
            <svg
              ...
              className="h-10 w-10"
            >
              <path fill="#000" d="M12 2L2 12h10L2 22h10L12 2z" />
            </svg>
          }
          heading="Notion"
        ...
        <GridItem
          icon={
            <svg
              ...
              height="24"
              viewBox="0 0 24 24"
              className="fill:[ rgba(230, 230, 218, 1)]"
            >
              <path
                fill-rule="evenodd"
                clip-rule="evenodd"
        ...
        <GridItem
          icon={
            ...
            >
              <path
                fill="#0052CC"
                d="M12 3.719l7.125 7.125-7.125 7.125-7.125-7.125z"
              />
            </svg>
          }
          heading="Confluence"
        ...
        <GridItem
          icon={
            ...
            >
              <path
                fill="#FF5A5F"
                d="M14.273 5.181c-.34-.553-.777-.957-1.25-1.116-.467-.157-.977-.167-1.442-.026-.457.141-.853.415-1.162.803-.486.644-.613 1.493-.338 2.251.278.758.892 1.339 1.585 1.531 1.003.278 2.053-.247 2.43-1.226.375-.977-.084-2.091-.976-2.513z"
              />
            </svg>
          }
          heading="Intercom"
        ...
        <GridItem
          icon={
            <svg
              ...
              className="h-10 w-10"
            >
              <path fill="#00B7D4" d="M9 19V5h6v14z" />
            </svg>
          }
          heading="Loom"
